...
export default defineConfig((ctx) => {
  ...
  console.log(`🚀 Quasar App Mode: ${backendMode.toUpperCase()}`);
  console.log(`📡 Backend Target: ${backendMode === 'remote' ? '10.2.0.6' : 'localhost'}`);
  ...
  return {
    ...
    build: {
      ...
      publicPath: '/icp-project-app/',  // เพิ่ม subpath
      ...
      env: {
        BACKEND_MODE: process.env.BACKEND_MODE || 'local',
