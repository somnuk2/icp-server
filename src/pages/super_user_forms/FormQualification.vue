                          ...
                          <q-card-section class="q-py-md">
                            <div class="row q-col-gutter-sm items-center">
                              ...
                              <div class="col-md-2 col-xs-12">
                                <q-btn color="primary" unelevated label="ค้นหา"
                          ...
                          <q-card-section class="q-py-md">
                            <div class="row q-col-gutter-md items-center">
                              ...
                              <div class="col-md-6 col-xs-12 text-center">
                                <q-btn flat color="black" label="ส่งออก excel" @click="exportTable()" class="full-width q-py-xs" />
                              </div>
                            </div>
                          </q-card-section>
                        </q-card>
                          ...
                          <q-table title="ข้อมูลคุณสมบัติ/ทักษะ" :rows="filteredQualifications" :columns="columns"
                            ...
                            <template v-slot:body-cell-actions="props">
                              <q-td :props="props" class="text-center">
                                <q-btn size="sm" color="blue" label="แก้ไข" unelevated no-caps @click="editUser(props.row.qa_plan_career_id)" />
