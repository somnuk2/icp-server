                    ...
                    <q-form @submit.prevent="submitForm()" @reset="resetForm()" method="post" class="q-gutter-md">
                      ...
                      <div class="row">
                        <div class="col-md-12 col-xs-12 q-pa-xs row justify-center">
                          ...
                          <q-btn color="primary" label="ไปฟอร์มข้อมูลส่วนตัว" no-caps flat to="/SuserFormComponent">
                      ...
                      <q-table title="ข้อมูลสาขาวิชา" :rows="individuals1" :columns="columns" row-key="department_id"
                        ...
                        <template v-slot:top-right="props">
                          <div class="row q-gutter-sm items-center">
                            ...
                            <q-input dense debounce="300" v-model="filter" placeholder="ค้นหาข้อมูลสาขาวิชา..."
                        ...
                        <template v-slot:body-cell-actions="props">
                          <q-td :props="props" class="text-center">
                            <q-btn size="sm" color="blue" label="แก้ไข" unelevated no-caps @click="editUser(props.row.department_id)" />
  ...
  methods: {
    ...
    async exportTable() {
      ...
      try {
        ...
        mainTitle.value = `รายงานข้อมูลสาขาวิชา (Super User Constance) - ${new Date().toLocaleDateString('th-TH')}`;
        ...
        worksheet.columns = [{ width: 10 }, { width: 60 }, { width: 40 }];
