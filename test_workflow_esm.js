...
async function testWorkflow() {
  console.log('--- Starting Workflow Test (ESM) ---');
  ...
  try {
    ...
    if (!careerId) {
       ...
       const newCar = await axios.post(`${baseUrl}/careers`, { career_name: 'Test Career ' + timestamp, career_group_id: grpId }, authHeader);
